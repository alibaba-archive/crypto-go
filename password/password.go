...
//
//  fmt.Println(crypto.Sign([]byte("salt..."), "user_id", "user_password"))
//  fmt.Println(crypto.Sign([]byte("salt..."), "user_id", "user_password"), 1024) // iterCount == 1024
//  fmt.Println(crypto.Sign([]byte("salt..."), "user_id", "user_password"), 1024, 32)
//
...
//
//  fmt.Println(crypto.Verify([]byte("salt..."), "user_id", "user_password", checkPass))
//
